...
<div class="card-body">
    ...
    <form action="{{ url('register') }}" novalidate method="get">
        {{ csrf_field() }}
        <div class="form-group">
            <label class="form-label" for="name">Name:</label>
            <div class="input-group input-group-merge">
                <input id="name" type="text" required="" name="name"
                class="form-control form-control-prepended" placeholder="Your first and last name">
        ...
        <div class="form-group">
            ...
            <div class="input-group input-group-merge">
                ...
                class="form-control form-control-prepended" placeholder="Choose a password">
                <div class="input-group-prepend">
                    <div class="input-group-text">
        ...
        <div class="form-group">
            ...
            <div class="input-group input-group-merge">
                <input id="password2" type="password" required="" name="confirmed"
...
<div class="card-footer text-center text-black-50">Already signed up? <a href="{{ url('login') }}">Login</a></div>
